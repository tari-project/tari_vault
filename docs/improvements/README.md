...
| [IMP-002](imp-002-zeroize-claim-id-string.md) | Zeroize incoming `claim_id` string | `[x]` |
...
| [IMP-004](imp-004-atomic-delete-proof.md) | Collapse `delete_proof` to single storage round-trip | `[x]` |
...
| [IMP-008](imp-008-fs2-replacement.md) | Replace unmaintained `fs2` file-lock crate | `[x]` |
| [IMP-009](imp-009-tracing.md) | Migrate from `log4rs` to `tracing` | `[x]` |
